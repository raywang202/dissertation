...
class EmaxLaborFunctionsJIT:
    ...
    def __init__(self,horizon,final_horizon,
        ...
        flows_penalized: legnth 3 vector of flow utilities for each sector,
        ...
        wage_shocks_sequence:  Analogue of wage_shocks, but from horizon up to
    ...
    # Per period flow is given by flow + wages * gamma_p; the ex-ante value
    # function is the average choice-specific over all of the wage shock
    # realizations
    #===========================================================================
        ...
        if time==self.final_horizon:
            for i in range(len_allocs):
                ...
                for last_choice in range(self.sectors+1):
                    ...
                    # ex-ante value is log-sum-exponential of choice-specific
                    # payouts. To prevent overflow, subtract by largest term
                    # first, then add back in
                    for j in range(N):
